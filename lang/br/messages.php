<?php return [
    ...
    "dashboard_message" => "Você esta Logado!",
    ...
    /** MENU **/
    "about" => "Sobre LFL",
    "library" => "LFL Livraria",
    "bazaar" => "LFL Bazaar",
    "agenda" => "Agenda",
    "prayer_box" => "Caixa de Preçes",
    "contact" => "Fale Conosco",
    "donate" => "Doações",
    "administration" => "Administração",
    "espiritism" => "Espiritismo",
    "founders" => "Fundadores",
    "lfl-news" => "LFL Notícias",
    "courses-trainning" => "Cursos & Treinamento",
    "our-calendar" => "Calendário",
    "message-board" => "Quadro de Avisos",
    ...
    // HOME PAGE //
    "welcome" => "Bem-vindo ao Lar Frei Luiz USA",
    "home_box1" => "Reunião Publíca Passes",
    "home_box2" => "Evangelização Infantil",
    "home_box3" => "Sessão de Irradiação",
    "home_box4" => "Estudo do Livro dos Espiritos",

    "welcome_box_1_title" => "Bem-vindo á LFL-USA",
    "welcome_box_1_subtitle" => "Organização Frei Luiz, sem fins lucrativos",
