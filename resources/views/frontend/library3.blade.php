        ...
        <div class="row">
            ...
            <div class="col-lg-4 sidebar">
                ...
                <div class="widgets-container">
                    <form id="search_library" name="search_library" action="{{ route('library') }}"
                                                ...
                                                <div class="brand-item">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                               id="{{ $author->name }}"
                                                               name="authors[]"
                                                               value="{{ $author->id }}" @checked(in_array($author->id, $searched_languages))>
                                                ...
                                                <div class="brand-item">
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label"
                                                               for="publishers">
                                                            {{ $publisher->name }}
                                                            <span class="brand-count">({{ $publisher->qtd }})</span>
                                                        </label>
                                                    </div>
                                                </div>
                                                {{--                                                                <li><a href="#" class="subcategory-link">{{ $publisher->name }}</a></li>--}}
                                        ...
                                        <div class="col-6">
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="number" id="price_range_max"
                                                       ...
                                                       value="{{ isset($_GET['price_range_max']) ? $_GET['price_range_max'] : 500 }}"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="product-box">
                                            <div class="product-thumb">
                                                ...
                                                <img
                                                    src="{{ empty($book->cover_image) ? 'https://upload.wikimedia.org/wikipedia/commons/6/65/No-Image-Placeholder.svg' : asset('storage/images/books/'.$book->cover_image) }}"
                                            ...
                                            <div class="product-content">
                                                ...
                                                <div class="product-rating-container">
                                                    <!--<span class="rating-number"><i class="bi bi-heart"></i> Not for sale - Only Study</span>
