        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12 mx-auto">
                ...
                <p class="text-white d-flex">
                    ...
                    <a href="mailto:info@lfl-usa.com" class="site-footer-link">
                        info@lfl-usa.com
                    </a>
                </p>
                ...
                <a href="https://maps.app.goo.gl/BukDbwFftZB2F6iM8" target="_blank" class="custom-btn btn mt-3">Get Direction</a>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-7 col-12">
                    <p class="copyright-text mb-0">Copyright © 2025 <a href="#">Lar Frei Luiz - USA</a> Charity Org.
                        Design: <a href="#" target="_blank">BigBits</a>
                    </p>
                </div>
