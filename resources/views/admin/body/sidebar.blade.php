...
{{--                                            <li><a href="index.html" class="slide-item">Multi Purpose </a></li>--}}
{{--                                            <li><a href="dashboard-ecommerce.html" class="slide-item">E-commerce </a></li>--}}
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
{{--                </li>--}}
{{--                <li class="slide">--}}
{{--                    <a class="sidenav-menu-item" href="private-chat.html"><i--}}
{{--                            class="side-menu__icon  ti ti-brand-hipchat"></i><span--}}
{{--                            class="side-menu__label">Chat</span>--}}
{{--                    </a>--}}
{{--                </li>--}}
{{--                <li class="slide">--}}
...
{{--                                                        class="sub-side-menu__label">View</span><i--}}
{{--                                                        class="sub-angle fe fe-chevron-right"></i></a>--}}
{{--                                                <ul class="sub-slide-menu">--}}
{{--                                                    <li><a class="sub-slide-item"--}}
{{--                                                           href="user-account-view.html">Account</a></li>--}}
{{--                                                    <li><a class="sub-slide-item"--}}
{{--                                                           href="user-security-view.html">Security</a></li>--}}
{{--                                                    <li><a class="sub-slide-item"--}}
{{--                                                           href="user-billing-view.html">Billing &--}}
{{--                                                            Plans</a></li>--}}
{{--                                                    <li><a class="sub-slide-item"--}}
{{--                                                           href="user-notifications-view.html">Notifications</a>--}}
{{--                                                    </li>--}}
{{--                                                    <li><a class="sub-slide-item"--}}
{{--                                                           href="user-connections-view.html">Connections</a>--}}
{{--                                                    </li>--}}
{{--                                                </ul>--}}
{{--                                            </li>--}}
{{--                                        </ul>--}}
                            ...
                            <div class="panel-body tabs-menu-body p-0 border-0">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="side1">
                                        <ul class="sidemenu-list">
                                            <li class="side-menu-label1"><a
                                                    href="javascript:void(0)">Livraria</a></li>
                                            <li><a href="{{ route('books.index') }}" class="slide-item">List Books</a></li>
                                            <li><a href="{{ route('books.create') }}" class="slide-item">Add Books</a></li>

{{--                                            <li><a href="ecommerce-product.html"--}}
{{--                                                   class="slide-item">Products</a></li>--}}
{{--                                            <li><a href="ecommerce-product-details.html"--}}
{{--                                                   class="slide-item">Products Detail</a></li>--}}
{{--                                            <li><a href="ecommerce-product-list.html"--}}
{{--                                                   class="slide-item">Product List</a></li>--}}
{{--                                            <li><a href="ecommerce-cart.html" class="slide-item">Cart</a>--}}
{{--                                            </li>--}}
...
{{--                                                    Charts</a></li>--}}
{{--                                            <li><a href="echarts.html" class="slide-item">ECharts</a></li>--}}
...
{{--                                                <a class="sub-sidenav-menu-item" data-bs-toggle="sub-slide"--}}
{{--                                                   href="javascript:void(0)"><span--}}
{{--                                                        class="sub-side-menu__label">C3 Charts</span><i--}}
{{--                                                        class="sub-angle fe fe-chevron-right"></i></a>--}}
{{--                                                <ul class="sub-slide-menu">--}}
{{--                                                    <li><a class="sub-slide-item" href="c-charts.html">Bar--}}
{{--                                                            Charts</a></li>--}}
{{--                                                    <li><a class="sub-slide-item"--}}
{{--                                                           href="line-chart.html">Line Charts</a></li>--}}
{{--                                                    <li><a class="sub-slide-item"--}}
{{--                                                           href="dount-charts.html">Dount Charts</a></li>--}}
...
{{--                <li class="slide">--}}
{{--                    <a class="sidenav-menu-item" data-bs-toggle="slide" href="javascript:void(0)"><i--}}
{{--                            class="side-menu__icon ti ti-forms"></i><span class="side-menu__label">Forms--}}
...
{{--                                    <div class="tab-pane active" id="side1">--}}
{{--                                        <ul class="sidemenu-list">--}}
{{--                                            <li class="side-menu-label1"><a href="javascript:void(0)">Forms--}}
{{--                                                    Elements</a></li>--}}
...
{{--                <li class="slide">--}}
{{--                    <a class="sidenav-menu-item" data-bs-toggle="slide" href="javascript:void(0)"><i--}}
{{--                            class="side-menu__icon ti ti-plug"></i><span class="side-menu__label">Forms--}}
...
{{--                                        Editors</span><i class="angle fe fe-chevron-right"></i>--}}
{{--                    </a>--}}
{{--                    <ul class="slide-menu">--}}
{{--                        <li class="panel sidetab-menu">--}}
{{--                            <div class="panel-body tabs-menu-body p-0 border-0">--}}
...
{{--                                                   class="slide-item">Summernote Editor</a></li>--}}
{{--                                        </ul>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
...
{{--                                            </li>--}}
{{--                                            <li><a href="edit-table.html" class="slide-item">Edit Tables</a>--}}
{{--                                            </li>--}}
{{--                                            <li><a href="tables-extension.html" class="slide-item">Tables--}}
{{--                                                    Extension</a></li>--}}
{{--                                        </ul>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
