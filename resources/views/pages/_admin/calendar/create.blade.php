...
@section('content')
    ...
    <form action="{{ route('calendar.store') }}" id="formLibrary" method="post" enctype="multipart/form-data">
        @csrf
        @method('post')
    <div class="row">
        <div class="col-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="mb-3 col">
                            ...
                            <input type="text" id="startDt" name="startDt" class="form-control date-time flatpickr-input" placeholder="Start Date &amp; Time of Event" readonly="readonly" required >
                            @error('startDt')
                            <div class="text-danger">* {{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3 col">
                            ...
                            <input type="text"  id="endDt" name="endDt" class="form-control" placeholder="End Date &amp; Time of Event" readonly="readonly">
                            @error('endDt')
                            <div class="text-danger">* {{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3 col">
                            ...
                            <input type="color" id="html5colorpicker" onchange="clickColor(0, -1, -1, 5)" value="#257e4a" style="width:85%;" name="color" >
                        </div>
                        <div class="mb-3 col">
                ...
                <div class="card-body">
                    <div class="align-content-center justify-content-center flex-wrap">
                        ...
                        <button type="submit" name="action_type" value="save" class="btn btn-success">Save Event</button>
                    </div>
                </div>
            </div>
